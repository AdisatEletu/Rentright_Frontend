 ...
 class ResidentialForm extends Component{
     ...
     if (this.props.myProfile){
           ...
           this.props.getFormStruct().then(()=>{         
             this.props.loadStructure('/profile/structure/?uuid='+this.uuid, true).then(()=>{
                   ...
                   this.props.breakFormToComponents(this.props.form.tenant_residence_history)
             }).catch((err)=>{
               console.log(err)
             }) 
           }).catch((err)=>{
    ...
    onUpdate =(data)=>{
     ...
     try{
      ...
      if( this.props.form.tenant_residence_history && this.props.form.tenant_residence_history[0] &&  this.props.form.tenant_residence_history[0][key].dependent_stat && this.props.form.tenant_residence_history[0][key].dependent_stat.have_dependents){
        this.props.form.tenant_residence_history[0][key].dependent_stat.dependent_name.map((item)=>{
  ...
  handleSubmit = ()=>{
    ...
    render(){                  
           return(     
  this.props.myProfile.tenants && this.props.form &&  this.props.myProfile.tenants.tenant_residence_history  && this.props.form.tenant_residence_history && this.props.form.tenant_residence_history[0] ?
        ...
        <div className = "t-md-6 t-fullheight p-widget deeper" >
         <div className= "m-profile-setup t-flex t-flex-column">
            ...
            <div className= "t-gray-darken-3-f mid t-h3 t-flex t-flex-column t-justify-space-between t-align-top p-widget m-padding ">
                 <span className= "t-uppercase t-h2 ">Update Residential Information</span>
                ...
                <CircleLinks linkTo = {"/tenant/profile/" + this.uuid } scale = {true} childLabel = "Overview" label = "A" isActive = {true}/>     
                 <CircleLinks linkTo = {"/tenant/profile/bioinfo/" + this.uuid} scale = {true} childLabel = "Bio Info" label = "1" isActive = {false}/>
                         <CircleLinks linkTo = {"/tenant/profile/residentialinfo/" + this.uuid} scale = {false} childLabel = "Residential Info" label = "2" isActive = {true}/>
                 <CircleLinks linkTo = {"/tenant/profile/employmentinfo/" + this.uuid} scale = {true} childLabel = "Employment Info" label = "3" isActive = {false}/>
                ...
                <CircleLinks linkTo = {"/tenant/profile/immigrationinfo/" + this.uuid} scale = {true} childLabel = "Immigration Info" label = "4" isActive = {false}/>
                 <CircleLinks linkTo = {"/tenant/profile/generalinfo/" + this.uuid} scale = {true} childLabel = "General Info" label = "5" isActive = {false}/>
                 </span>
                :
                 <CircleLinks linkTo = {"/tenant/profile/generalinfo/" + this.uuid} scale = {true} childLabel = "General Info" label = "4" isActive = {false}/>
                :null}
                </div>
             ...
             {this.state.tenant_residence_history ?
             ...
             <div className="p-widget m-padding t-md-10">   
               <div className = "m-heading increase">Your Resdiential History</div>
             ...
             { this.props.formBreakDownData ?
              ...
              {  this.props.formBreakDownData.text.length  > 0 && this.props.form.tenant_residence_history ? 
                <div className = "double-container"> 
                  {this.props.formBreakDownData.text.map((item,index) =>{
                  if(this.props.form.tenant_residence_history && this.props.form.tenant_residence_history[0]) {     
                  return(  
                 this.props.form.tenant_residence_history && this.props.form.tenant_residence_history[0] &&  this.props.form.tenant_residence_history[0][item] && this.props.form.tenant_residence_history[0][item].dependent_stat && ! this.props.form.tenant_residence_history[0][item].dependent_stat.is_dependent  ?      
                    <NewForm key = {index} onUpdate = {this.onUpdate.bind(this)} datatype = {"text"}  label =  {this.props.form.tenant_residence_history[0]} ownstate = {this.state} name = {this.props.form.tenant_residence_history[0][item].key}  keyname = {this.props.form.tenant_residence_history[0][item].keyname}  data = {this.props.formBreakDownData.text}    />
                     : 
               ...
               {  this.props.formBreakDownData.phone.length  > 0 ? 
                <div className = "double-container"> 
                  ...
                  if (this.props.form.tenant_residence_history && this.props.form.tenant_residence_history[0] &&  this.props.form.tenant_residence_history[0][item] )  {  
                  return(  
                 this.props.form.tenant_residence_history && this.props.form.tenant_residence_history[0] &&  this.props.form.tenant_residence_history[0][item] &&   this.props.form.tenant_residence_history[0][item].dependent_stat && ! this.props.form.tenant_residence_history[0][item].dependent_stat.is_dependent  ?      
                    <NewForm key = {index} onUpdate = {this.onUpdate.bind(this)} datatype = {"phone"}  label =  {this.props.form.tenant_residence_history[0]} ownstate = {this.state} name = {this.props.form.tenant_residence_history[0][item].key}  keyname = {this.props.form.tenant_residence_history[0][item].keyname}  data = {this.props.formBreakDownData.phone}    />
                     : 
                    this.props.form.tenant_residence_history[0][item].dependent_stat ?
                    this.state.obj2 && this.state.obj2[item] ? 
                  <NewForm key = {index} onUpdate = {this.onUpdate.bind(this)} datatype = {"phone"}  label =  {this.props.form.tenant_residence_history[0]} ownstate = {this.state}  name = {this.props.form.tenant_residence_history[0][item].key}   keyname = {this.props.form.tenant_residence_history[0][item].keyname}  data = {this.props.formBreakDownData.phone}    />
                     :
                     null
                ...
                <div className = "double-container"> 
                  ...
                  return(  
                   this.props.form.tenant_residence_history && this.props.form.tenant_residence_history[0] &&  this.props.form.tenant_residence_history[0][item] && this.props.form.tenant_residence_history[0][item].dependent_stat && ! this.props.form.tenant_residence_history[0][item].dependent_stat.is_dependent  ?      
                    <NewForm key = {index} onUpdate = {this.onUpdate.bind(this)} datatype = {"date"}  label =  {this.props.form.tenant_residence_history[0]} ownstate = {this.state} name = {this.props.form.tenant_residence_history[0][item].key}  keyname = {this.props.form.tenant_residence_history[0][item].keyname}  data = {this.props.formBreakDownData.date}    />
                     : 
                    this.state.obj2 && this.state.obj2[item] ? 
                  <NewForm key = {index} onUpdate = {this.onUpdate.bind(this)} datatype = {"date"}  label =  {this.props.form.tenant_residence_history[0]} ownstate = {this.state}  name = {this.props.form.tenant_residence_history[0][item].key}   keyname = {this.props.form.tenant_residence_history[0][item].keyname}  data = {this.props.formBreakDownData.date}    />
                      :
              ...
              this.props.formBreakDownData.select.length  > 0 ? 
                <div className = "double-container"> 
                  ...
                  return(  
                  this.props.form.tenant_residence_history && this.props.form.tenant_residence_history[0] &&  this.props.form.tenant_residence_history[0][item] && this.props.form.tenant_residence_history[0][item].dependent_stat &&  ! this.props.form.tenant_residence_history[0][item].dependent_stat.is_dependent  ?   
                    <NewForm key = {index} onUpdate = {this.onUpdate.bind(this)} datatype = {"select"}  label =  {this.props.form.tenant_residence_history[0]} ownstate = {this.state} name = {this.props.form.tenant_residence_history[0][item].key}  options = {this.props.form.tenant_residence_history[0][item].options}  keyname = {this.props.form.tenant_residence_history[0][item].keyname}  data = {this.props.formBreakDownData.select}    />
                   :
                   this.state.obj2 && this.state.obj2[item] ? 
                    <NewForm key = {index} onUpdate = {this.onUpdate.bind(this)} datatype = {"select"}  label =  {this.props.form.tenant_residence_history[0]} ownstate = {this.state} options = {this.props.form.tenant_residence_history[0][item].options}  keyname = {this.props.form.tenant_residence_history[0][item].keyname}  data = {this.props.formBreakDownData.select}    />
                   :
                   null
                  )
                   }
                 ...
                 
               {
                ...
                <div className = "double-container"> 
                  ...
                  return(  
                  this.props.form.tenant_residence_history && this.props.form.tenant_residence_history[0] &&  this.props.form.tenant_residence_history[0][item] && this.props.form.tenant_residence_history[0][item].dependent_stat && this.props.form.tenant_residence_history[0][item].dependent_stat.is_dependent  ?   
                    <NewForm key = {index} onUpdate = {this.onUpdate.bind(this)} datatype = {"textarea"} name = {this.props.form.tenant_residence_history[0][item].key}   label =  {this.props.form.tenant_residence_history[0]} ownstate = {this.state} options = {this.props.form.tenant_residence_history[0][item].options}  keyname = {this.props.form.tenant_residence_history[0][item].keyname}  data = {this.props.formBreakDownData.textarea}    />
                 :
                  this.state ? 
                  <NewForm key = {index} onUpdate = {this.onUpdate.bind(this)} datatype = {"textarea"}  name = {this.props.form.tenant_residence_history[0][item].key}   label =  {this.props.form.tenant_residence_history[0]} ownstate = {this.state} options = {this.props.form.tenant_residence_history[0][item].options}  keyname = {this.props.form.tenant_residence_history[0][item].keyname}  data = {this.props.formBreakDownData.textarea}    />
                 :
               ...
               <div className = "m-loader-container  t-flex-column t-justify-center t-align-center">
                   ...
                   <div className = "p-button-container t-flex t-align-center t-justify-space-between">            
                    ...
                    <NavLink to = {"/tenant/profile/employmentinfo/" + this.props.match.params.id}><Button type="default"  size="large">Next<Icon type="right" /> </Button></NavLink>
                    {this.props.myProfile.tenants.general_info ? this.props.myProfile.tenants.general_info.are_you_an_immigrant ? 
                    <NavLink to = {"/tenant/profile/immigrationinfo/" + this.props.match.params.id}><Button type="default"  size="large">Next<Icon type="right" /> </Button></NavLink> 
                    :
                    <NavLink to = {"/tenant/profile/bioinfo" + this.props.match.params.id}><Button type="default"  size="large">Back<Icon type="right" /> </Button></NavLink> 
                     : null}  
...
<div className = "m-heading increase">Past Residence</div>
 ...
 {   this.props.myProfile ? this.props.myProfile.tenants.tenant_residence_history.length > 0  ?  
          this.props.myProfile.tenants.tenant_residence_history.map ( (item, index)=>{ 
            if (this.props.myProfile.tenants.tenant_residence_history && item) {                           
          return(      
             ...
             <div className = "t-flex t-flex-column t-md-10">
                ...
                <div className = "double-container nobg"> 
                  {this.props.formBreakDownData.switch.map((item,index) =>{
                    if(this.props.form.tenant_residence_history && this.props.form.tenant_residence_history[0] && this.props.form.tenant_residence_history[0][item] ) {   
                  return(  
                    <NewForm key = {index} onUpdate = {this.onUpdate.bind(this)} datatype = {"switch"}  label =  {this.props.form.tenant_residence_history[0]} ownstate = {this.state} field = {item}  keyname = {this.props.form.tenant_residence_history[0][item].keyname}  data = {this.props.formBreakDownData.switch}    />
                  )
                    }
                  }) 
                  }
