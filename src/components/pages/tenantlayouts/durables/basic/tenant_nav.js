...
return (
   <div className = "t-nav">
     ...
     <div className = "curved t-flex t-justify-left t-flex-row p-curved-serach "><Icon style = {{color:'rgba(255,255,255,0.2)', fontSize:'20px', lineHeight:'35px', marginRight:'20px'}} type = "search"/><input type = "text" placeholder = "Search ..."/></div>      
